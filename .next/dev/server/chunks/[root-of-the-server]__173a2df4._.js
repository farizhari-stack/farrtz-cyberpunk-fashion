...
async function POST(request) {
    try {
        ...
        const { data: user, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('users').select('*').eq('email', email).single();
        if (error || !user) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__173a2df4._.js.map